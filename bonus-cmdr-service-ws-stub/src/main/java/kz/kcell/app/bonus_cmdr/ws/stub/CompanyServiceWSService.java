 ...
 * 2017-12-25T16:34:31.984+06:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "CompanyServiceWSService", 
                  wsdlLocation = "http://localhost:8080/services/company?wsdl",
...
public class CompanyServiceWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/services/company?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CompanyServiceWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/services/company?wsdl");
        }
        WSDL_LOCATION = url;
    }
