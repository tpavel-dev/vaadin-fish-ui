 ...
 * 2017-12-25T16:34:31.858+06:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "AuthServiceWSService", 
                  wsdlLocation = "http://localhost:8080/services/auth?wsdl",
...
public class AuthServiceWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/services/auth?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AuthServiceWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/services/auth?wsdl");
        }
        WSDL_LOCATION = url;
    }
